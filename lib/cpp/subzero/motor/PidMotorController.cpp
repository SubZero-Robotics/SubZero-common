...
PidMotorController<TMotor, TController, TRelativeEncoder, TAbsoluteEncoder>::PidMotorController(std::string name, TMotor &motor,
...
template <typename TMotor, typename TController, typename TRelativeEncoder,
          typename TAbsoluteEncoder>
void PidMotorController<TMotor, TController, TRelativeEncoder, TAbsoluteEncoder>::Set(units::volt_t volts)
{
...
template <typename TMotor, typename TController, typename TRelativeEncoder,
          typename TAbsoluteEncoder>
void PidMotorController<TMotor, TController, TRelativeEncoder, TAbsoluteEncoder>::SetPidTolerance(double tolerance)
{
...
template <typename TMotor, typename TController, typename TRelativeEncoder,
          typename TAbsoluteEncoder>
void PidMotorController<TMotor, TController, TRelativeEncoder, TAbsoluteEncoder>::Update()
{
...
template <typename TMotor, typename TController, typename TRelativeEncoder,
          typename TAbsoluteEncoder>
void PidMotorController<TMotor, TController, TRelativeEncoder, TAbsoluteEncoder>::RunWithVelocity(units::revolutions_per_minute_t rpm)
{
    m_absolutePositionEnabled = false;
...
template <typename TMotor, typename TController, typename TRelativeEncoder,
          typename TAbsoluteEncoder>
void PidMotorController<TMotor, TController, TRelativeEncoder, TAbsoluteEncoder>::RunWithVelocity(double percentage)
{
...
template <typename TMotor, typename TController, typename TRelativeEncoder,
          typename TAbsoluteEncoder>
void PidMotorController<TMotor, TController, TRelativeEncoder, TAbsoluteEncoder>::RunToPosition(double position)
{
...
template <typename TMotor, typename TController, typename TRelativeEncoder,
          typename TAbsoluteEncoder>
std::optional<double> PidMotorController<TMotor, TController, TRelativeEncoder, TAbsoluteEncoder>::GetAbsoluteEncoderPosition()
{
    if (m_absEncoder)
    {
...
template <typename TMotor, typename TController, typename TRelativeEncoder,
          typename TAbsoluteEncoder>
void PidMotorController<TMotor, TController, TRelativeEncoder, TAbsoluteEncoder>::Stop()
{
    m_absolutePositionEnabled = false;
    m_motor.Set(0);
}
...
template <typename TMotor, typename TController, typename TRelativeEncoder,
          typename TAbsoluteEncoder>
void PidMotorController<TMotor, TController, TRelativeEncoder, TAbsoluteEncoder>::UpdatePidSettings(PidSettings settings)
{

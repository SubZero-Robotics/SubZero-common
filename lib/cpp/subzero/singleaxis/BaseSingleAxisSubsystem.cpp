...
template <typename TController, typename TDistance>
void BaseSingleAxisSubsystem<TController, TDistance>::RunMotorPercentage(double percentSpeed,
                                                                         bool ignoreEncoder)
{
...
template <typename TController, typename TDistance>
frc2::CommandPtr BaseSingleAxisSubsystem<TController, TDistance>::MoveToPositionAbsolute(Distance_t position)
{
...
template <typename TController, typename TDistance>
bool BaseSingleAxisSubsystem<TController, TDistance>::IsMovementAllowed(double speed, bool ignoreEncoder)
{
...
template <typename TController, typename TDistance>
bool BaseSingleAxisSubsystem<TController, TDistance>::IsMovementAllowed(bool ignoreEncoder)
{
    if (m_config.ignoreLimit())
        return true;

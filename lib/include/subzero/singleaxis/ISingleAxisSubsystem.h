 ...
 * 
 * @tparam Distance The distance unit- typically meter, inch, degree, radian, etc.
 */
...
class ISingleAxisSubsystem {
 public:
  ...
  struct SingleAxisConfig {
     ...
     * 
     * @example For a 10:1 reduction, value would be 36 degrees rather than 360 for 1:1
     */
    Distance_t encoderDistancePerRevolution;
    /**
     * @brief Similar to encoderDistancePerRevolution but using the absolute encoder
     * 
     */
    ...
    /**
     * @brief Absolute positioning goal is reached within a range of +/- this value
     * 
     */
    Distance_t tolerance;
    /**
     * @brief Optional. Will check for the limit switch being active when seeing if at limit
     * 
     */
    ...
    /**
     * @brief Optional. Will be called on each loop; useful for outputting values to SmartDashboard in a different unit than the given one
     * 
     */
  ...
  /**
   * @brief Run at the given velocity; disables any in-progress absolute movements
   * 
   * @param speed 
   * @param ignoreEncoder 
   */
  ...
  /**
   * @brief Run at the given velocity percentage; disables any in-progress absolute movements
   * 
   * @param speed 
   * @param ignoreEncoder 
   */
  ...
  /**
   * @brief Start moving to the position given the current distance and relative position
   * 
   * @param position 
   * @return frc2::CommandPtr 
   */
